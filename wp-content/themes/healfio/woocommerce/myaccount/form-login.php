...
<div class="u-columns col2-set" id="customer_login">
    ...
    <div class="u-column1 col-lg">
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <div class="login-btn"><button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="<?php esc_attr_e( 'Log in', 'healfio' ); ?>"><?php esc_html_e( 'Log in', 'healfio' ); ?></button></div>
            </div>
    ...
    <div class="u-column2 col-lg">
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
            ...
            <?php else : ?>
                ...
                <p><?php esc_html_e( 'A password will be sent to your email address.', 'healfio' ); ?></p>
