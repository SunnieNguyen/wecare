        ...
        */
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#FFFFFF',
				'selectors' => [
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner :is(a, button, .button)' => 'background: {{VALUE}} !important;',
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner :is(a, button, .button):hover' => 'background: {{VALUE}} !important;',
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner' => 'background-color: {{VALUE}} !important;',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#101010',
				'selectors' => [
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner a' => 'transition: none !important; color: {{VALUE}} !important;'
				],
			]
		);
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#F03D3F',
				'selectors' => [
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner a:hover' => 'color: {{VALUE}} !important;',
                    '{{WRAPPER}} .loop-product--btns .loop-product--btns-inner a.active' => 'color: {{VALUE}} !important;',
                    '{{WRAPPER}} .loop-product--btns .loop-product--btns-inner a:hover i' => 'color: {{VALUE}} !important;',
                    '{{WRAPPER}} .loop-product--btns .loop-product--btns-inner a.active i' => 'color: {{VALUE}} !important;',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner :is(svg)' => 'width: {{SIZE}}{{UNIT}} !important;',
					'{{WRAPPER}} .loop-product--btns a.add_to_cart_button::before' => 'font-size: {{SIZE}}{{UNIT}} !important;',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .loop-product--btns .loop-product--btns-inner :is(a, button, .button)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',
				],
			]
		);
