	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '#DCDCDC',
				'selectors' => [
					'{{WRAPPER}} .shopengine-checkout-review-order .woocommerce-checkout-review-order-table tfoot tr:not(.woocommerce-shipping-totals)' => 'box-shadow: 0px 1px {{VALUE}}, 0 3px #ffffff;',
				],
			]
		);
