...
**Staff List** - responsive WordPress plugin to create and display staff directory, faculty directory, employee directory, company directory or other types of team members listings. 
...
One-time payment, <strong>free updates</strong> for the life of the plugin.
