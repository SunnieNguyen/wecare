...
class Client extends \Wappointment\Remote\AbstractClient implements \Wappointment\Remote\InterfaceClient
{
    ...
    public function post($url)
    {
        ...
        $this->response = new \Wappointment\Remote\WP\Response(wp_remote_post($url, $this->getParams()));
    ...
    public function get($url)
    {
        ...
        $this->response = new \Wappointment\Remote\WP\Response(wp_remote_get($url, $this->getParams()));
        return $this->response;
    }
