...
class WpMail extends \Wappointment\Transports\Transport
{
    ...
    public function sendTheRightWay($to, $message)
    {
        ...
        if (\Wappointment\WP\PluginsDetection::smtpConfigured() || \Wappointment\WP\PluginsDetection::createsEmailConflict()) {
    ...
    {
        return \Wappointment\WP\PluginsDetection::smtpConfigured() || \Wappointment\WP\PluginsDetection::createsEmailConflict() ? 'text/html' : 'multipart/alternative';
    }
    /**
