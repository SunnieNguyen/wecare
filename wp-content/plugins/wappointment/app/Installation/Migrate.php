...
class Migrate extends \WappoVendor\Illuminate\Database\Migrations\Migration
{
    ...
    {
        $this->capsule = \Wappointment\Config\Database::capsule();
        $this->migrationRepo = new \WappoVendor\Illuminate\Database\Migrations\DatabaseMigrationRepository($this->capsule->getDatabaseManager(), \Wappointment\Config\Database::$prefix_self . '_migrations');
    ...
    {
        return is_multisite() ? \Wappointment\ClassConnect\Capsule::connection()->getTablePrefix() . $name : $name;
    }
