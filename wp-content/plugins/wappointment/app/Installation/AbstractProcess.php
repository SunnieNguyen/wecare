...
class AbstractProcess
{
    ...
    protected function setNextStep()
    {
        ...
        if ($this->currentStep === true) {
            ...
            \Wappointment\WP\Helpers::deleteOption($this->key);
    ...
    {
        return \Wappointment\WP\Helpers::setOption($this->key, $stepValue);
    }
    protected function loadCurrentStep()
    {
        return \Wappointment\WP\Helpers::getOption($this->key);
    }
