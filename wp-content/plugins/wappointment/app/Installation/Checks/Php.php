...
class Php extends \Wappointment\Installation\MethodsRunner
{
    protected function canRunPhp()
    {
        ...
        if (\version_compare(\PHP_VERSION, $max) >= 0) {
            throw new \WappointmentException('Wappointment is not yet compatible with PHP 8 yet. You can install our PHP 8 beta version following this guide: https://wappointment.com/docs/installing-php8-version/');
        }
    }
}
