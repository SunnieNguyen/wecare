...
class SeedData extends \Wappointment\Installation\MethodsRunner
{
    public function remindersToSeed()
    {
        ...
        return [['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_PENDING, 'subject' => __('Your appointment is pending', 'wappointment'), 'published' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap([
        ...
        ])]], ['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_RESCHEDULED, 'subject' => __('Your appointment has been rescheduled', 'wappointment'), 'published' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap([
            /* translators: %s - client's first name. */
            ['p' => \sprintf(__('Dear %s,', 'wappointment'), '[client:name]')],
            ['p' => ''],
            ...
            ['p' => \WappointmentLv::blogname()],
        ])]], ['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_CANCELLED, 'subject' => __('Your appointment has been cancelled', 'wappointment'), 'published' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap([
            /* translators: %s - client's first name. */
            ['p' => \sprintf(__('Dear %s,', 'wappointment'), '[client:name]')],
            ['p' => ''],
            /* translators: %s - appointment starts date. */
