...
class Preferences
{
    ...
    {
        $pref = \Wappointment\WP\Helpers::getStaffOption('preferences', \Wappointment\WP\Helpers::userId());
        if (!empty($pref)) {
    ...
    {
        \Wappointment\WP\Helpers::setStaffOption('preferences', $this->preferences, \Wappointment\WP\Helpers::userId());
    }
}
