...
class Services implements \Wappointment\Services\ServiceInterface
{
    public static function getModel()
    {
        return \Wappointment\Managers\Service::model();
    }
    ...
    public static function save($serviceData)
    {
        ...
        $validator->addValidator('required_if_fields', new \Wappointment\Validators\RequiredIfFields());
    ...
    public static function updatePricesReference($id, $serviceData)
    {
        ...
        \Wappointment\Models\Price::whereIn('id', $price_ids)->update(['reference_id' => $id]);
    }
    ...
    public static function hasZoom($service)
    {
        if (\is_array($service)) {
            foreach ($service['locations'] as $location) {
                if ((int) $location['type'] === \Wappointment\Models\Location::TYPE_ZOOM) {
                    return true;
                }
            }
        } else {
