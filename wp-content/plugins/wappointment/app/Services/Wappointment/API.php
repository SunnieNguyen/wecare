...
abstract class API
{
    ...
    {
        $this->client = new \Wappointment\Remote\Request();
        $this->site_key = \Wappointment\WP\Helpers::getOption('site_key');
    }
    ...
    protected function getParams($params = [])
    {
        ...
        return \array_merge(['Site-Name' => \Wappointment\WP\Helpers::getWPOption('blogname'), 'Site-Url' => rest_url(), 'Site-Wp-Version' => get_bloginfo('version'), 'Site-Php-Version' => \PHP_VERSION], $params);
    }
