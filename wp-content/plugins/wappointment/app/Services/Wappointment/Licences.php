...
class Licences extends \Wappointment\Services\Wappointment\API
{
    ...
    {
        return !empty($this->getSiteKey()) && !empty(\Wappointment\WP\Helpers::getOption('site_details'));
    }
    ...
    {
        return \Wappointment\WP\Helpers::deleteOption('site_details');
    }
    public function canUseAddon($addon_name)
    {
        $site_options = \json_decode(\Wappointment\WP\Helpers::getOption('site_details'));
    ...
    {
        return \Wappointment\WP\Helpers::setOption('site_details', \json_encode($data));
    }
    protected function recordSiteKey($data)
    {
        ...
        if (!empty($data->details)) {
            \Wappointment\WP\Helpers::setOption('site_details', \json_encode($data->details));
        }
        return \Wappointment\WP\Helpers::setOption('site_key', $data->sitekey);
    }
