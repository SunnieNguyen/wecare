...
class WidgetSettings
{
    ...
    {
        $this->settings = \Wappointment\Helpers\Get::list('widget_settings');
        $this->fields = \Wappointment\Helpers\Get::list('widget_fields');
        $this->steps = \Wappointment\Helpers\Get::list('widget_steps');
        $ppolicy = get_privacy_policy_url();
        $this->settings['form']['terms_link'] = empty($ppolicy) ? 'http://' : $ppolicy;
        $this->db_settings = \Wappointment\WP\Helpers::getOption($this->key_option, []);
    ...
    {
        $settings['i18n'] = \Wappointment\Helpers\Get::list('widget_translations');
        return $settings;
    }
    ...
    {
        return \Wappointment\WP\Helpers::setOption($this->key_option, $this->filterSettings($settings), true);
    }
