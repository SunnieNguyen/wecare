...
class Calendar
{
    ...
    {
        return $this->legacy ? \Wappointment\WP\Helpers::getStaffOption('calendar_logs') : $this->returnStaffLogs();
    }
    ...
    public function fetch()
    {
        ...
        $client = new \Wappointment\Remote\Request();
    ...
    {
        if ($this->legacy) {
            return \Wappointment\WP\Helpers::setStaffOption('calendar_logs', $this->calendar_logs, $this->getStaffId());
        } else {
