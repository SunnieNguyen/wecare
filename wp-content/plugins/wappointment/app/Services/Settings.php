...
class Settings
{
    ...
    protected static function getValues($reset = false)
    {
        if (static::$settings === false) {
            static::$settings = \Wappointment\WP\Helpers::getOption(static::$key_option);
        }
    ...
    protected static function getStaffValues($staff_id = false, $reset = false)
    {
        ...
        if (!isset(static::$staffSettings[$staff_id])) {
            static::$staffSettings[$staff_id] = \Wappointment\WP\Helpers::getStaffOption(static::$key_option, $staff_id, self::staffDefaults());
        }
    ...
    public static function allDefaults()
    {
        return [
            ...
            'week_starts_on' => 1,
            // 1 stands for monday
            'date_format' => \Wappointment\WP\Helpers::getWPOption('date_format'),
            'time_format' => \Wappointment\WP\Helpers::getWPOption('time_format'),
            'date_time_union' => ' - ',
            ...
            'regavDefault' => ['monday' => [[480, 720], [840, 1140]], 'tuesday' => [[480, 720], [840, 1140]], 'wednesday' => [[480, 720], [840, 1140]], 'thursday' => [[480, 720], [840, 1140]], 'friday' => [[480, 720], [840, 1140]], 'saturday' => [], 'sunday' => [], 'precise' => true],
    ...
    {
        return \ucfirst(\Wappointment\WP\Helpers::currentUserName());
    }
    ...
    {
        $parsed_url = \parse_url(\Wappointment\WP\Helpers::getWPOption('home'));
    ...
    {
        $timezone = \Wappointment\WP\Helpers::getWPOption('timezone_string');
    ...
    public static function save($setting_key, $value)
    {
        ...
        if ($updatedValues !== false) {
            \Wappointment\WP\Helpers::setOption(static::$key_option, $updatedValues, true);
    ...
    public static function delete()
    {
        ...
        return \Wappointment\WP\Helpers::deleteOption(static::$key_option);
    }
    ...
    public static function saveStaff($setting_key, $value, $staff_id = false)
    {
        ...
        if (static::valid($setting_key, $value, $staff_id)) {
            ...
            \Wappointment\WP\Helpers::setStaffOption(static::$key_option, $values, $staff_id);
            ...
            return ['message' => empty(static::$msg) ? \Wappointment\Helpers\Translations::get('element_saved') : static::$msg];
        }
    }
    public static function deleteStaff($staff_id = false)
    {
        ...
        return \Wappointment\WP\Helpers::deleteStaffOption(static::$key_option, $staff_id);
    }
    ...
    {
        $booking_allowed_from = \Wappointment\ClassConnect\Carbon::now()->timestamp + \Wappointment\Services\Settings::get('hours_before_booking_allowed') * 60 * 60;
    ...
    {
        return $value > 0 && \Wappointment\WP\Helpers::getUserBy('id', $value) !== false ? true : false;
    }
    protected static function activeStaffIdBeforeSave($newStaffId)
    {
        //transfer all staff id settings to the right full owner
        \Wappointment\WP\Helpers::transferStaffOptions(\Wappointment\Services\Settings::get('activeStaffId'), $newStaffId);
    }
