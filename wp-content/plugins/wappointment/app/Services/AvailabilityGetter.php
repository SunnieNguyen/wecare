...
class AvailabilityGetter
{
    ...
    public function __construct($staff = null, $start_at = false, $end_at = false)
    {
        ...
        if (!empty($staff)) {
            ...
            $this->selectedStaff = new \Wappointment\WP\StaffLegacy();
        }
    }
    ...
    public function getSections()
    {
        ...
        if (!$this->start_at) {
            //no section specified, we take it all
    ...
    protected function isIntersecting($availability)
    {
        ...
        return $availability[0] >= $this->start_at && $availability[0] < $this->end_at || $availability[1] > $this->start_at && $availability[1] <= $this->end_at;
    }
