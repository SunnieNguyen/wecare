...
class Reminder
{
    public static function save($reminderData)
    {
        ...
        if (isset($reminderData['id']) && $reminderData['id'] > 0) {
            ...
            return (bool) \Wappointment\Models\Reminder::where('id', (int) $reminderData['id'])->update($reminderData);
        } else {
            return (bool) \Wappointment\Models\Reminder::create($reminderData);
        }
    }
    public static function delete($id)
    {
        return \Wappointment\Models\Reminder::destroy($id);
    }
    public static function preview($id, $recipient)
    {
        $reminder = \Wappointment\Models\Reminder::find($id);
    ...
    {
        return (new \Wappointment\Services\Mail())->to($recipient)->send($reminder->toMailable(new \Wappointment\Models\Appointment()));
    }
    ...
    {
        $email_type = \Wappointment\Models\Reminder::getType('email');
        $arraySeeds[] = ['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_PENDING, 'subject' => __('Your appointment is pending', 'wappointment'), 'published' => 1, 'locked' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap([
        ...
        $arraySeeds[] = ['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_RESCHEDULED, 'subject' => __('Your appointment has been rescheduled', 'wappointment'), 'published' => 1, 'locked' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap([
            /* translators: %s - client's first name. */
            ['p' => \sprintf(__('Dear %s,', 'wappointment'), '[client:name]')],
            ['p' => ''],
        ...
        $arraySeeds[] = ['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_CANCELLED, 'subject' => __('Your appointment has been cancelled', 'wappointment'), 'published' => 1, 'locked' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap([
            /* translators: %s - client's first name. */
            ['p' => \sprintf(__('Dear %s,', 'wappointment'), '[client:name]')],
            ['p' => ''],
            /* translators: %s - appointment starts date. */
    ...
    public static function remindersToSeed($types)
    {
        ...
        $email_type = \Wappointment\Models\Reminder::getType('email');
        return [['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_CONFIRMED, 'subject' => __('Your appointment has been confirmed', 'wappointment'), 'locked' => 1, 'published' => 1, 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap($email_confirmed)]], ['type' => $email_type, 'event' => \Wappointment\Models\Reminder::APPOINTMENT_STARTS, 'locked' => 0, 'published' => 1, 'subject' => __('Don\'t forget your appointment', 'wappointment'), 'options' => ['body' => \Wappointment\Helpers\TipTap::simpleArrayToTipTap($email_reminder), 'when_number' => '1', 'when_unit' => '3']]];
    }
}
