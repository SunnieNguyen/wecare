...
class AdminEmailDailySummary extends \Wappointment\Jobs\AbstractEmailJob
{
    ...
    {
        \Wappointment\Services\Queue::queueDailyJob(!empty($this->params['staff_id']) ? $this->params['staff_id'] : false);
    }
    protected function prepareEmailSend()
    {
        $notifications_emails = \Wappointment\Services\Settings::get('email_notifications');
