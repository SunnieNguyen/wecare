...
trait IsAppointmentJob
{
    ...
    protected function parseParams($params)
    {
        ...
        $this->client = (new \Wappointment\Models\Client())->fill($params['client']);
        ...
        $this->appointment = apply_filters('wappointment_appointment_job_params_parse', (new \Wappointment\Models\Appointment())->newFromBuilder($params['appointment']), $params);
