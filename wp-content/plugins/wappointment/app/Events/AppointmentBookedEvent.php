...
class AppointmentBookedEvent extends \Wappointment\Events\AbstractEvent
{
    ...
    public function __construct($args)
    {
        ...
        $this->reminders = \Wappointment\Models\Reminder::select('id', 'event', 'type', 'options')->where('published', 1)->whereIn('type', \Wappointment\Models\Reminder::getTypes('code'))->get();
    }
