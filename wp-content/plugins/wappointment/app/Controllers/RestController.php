...
abstract class RestController
{
    ...
    public function tryExecute($param)
    {
        ...
        try {
            ...
            $request = \Wappointment\WP\Helpers::requestGet($param->get_params());
        ...
        if (!empty($this->getErrors())) {
            if ($this->hasOneErrorOnly()) {
                return \Wappointment\WP\Helpers::restError($this->hasOneErrorOnly(), 500);
            }
            $errors = $this->getErrors();
            return \Wappointment\WP\Helpers::restError($errors['default'][0], 500, $errors);
        }
        return $result;
    }
