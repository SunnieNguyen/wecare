...
class TagsReplacement
{
    ...
    {
        return apply_filters('wappointment_emails_tags', static::appendStaffCF(\Wappointment\Helpers\Get::list('email_tags')));
    }
    public static function appendStaffCF($email_tags_core)
    {
        if (\Wappointment\Services\Settings::get('allow_staff_cf')) {
            $custom_fields = \Wappointment\WP\Helpers::getOption('staff_custom_fields', []);
    ...
    {
        return apply_filters('wappointment_emails_links', \Wappointment\Helpers\Get::list('email_links'));
    }
