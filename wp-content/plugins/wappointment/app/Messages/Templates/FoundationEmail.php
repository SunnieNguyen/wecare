...
class FoundationEmail
{
    ...
    public function logo($logo = [])
    {
        if ($logo) {
            ...
            return $this->wrapRow('<center><a class="text-center" href="' . apply_filters('wappointment_admin_email_head_link', \Wappointment\System\Helpers::wappointmentLink('email', 'daily_email')) . '">' . '<img class="float-center" alt="wappointment.com" src="' . apply_filters('wappointment_admin_email_head_image', \Wappointment\System\Helpers::pluginUrl('/dist/images/wappointment_80.png')) . '" ></a> </center>', 'row collapsed wappointment', 'row body-border radius', '', '', false);
        }
    }
