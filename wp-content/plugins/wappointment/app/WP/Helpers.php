...
class Helpers
{
    ...
    public static function wpUserData($permission = false)
    {
        ...
        $data = ['email' => $wp_user->user_email, 'name' => $wp_user->display_name, 'autofill' => \Wappointment\Services\Settings::get('autofill'), 'forceemail' => \Wappointment\Services\Settings::get('forceemail')];
        if ($permission) {
