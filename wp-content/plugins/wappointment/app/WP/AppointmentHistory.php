...
class AppointmentHistory
{
    ...
    public function loadData()
    {
        ...
        if (!empty($email)) {
            $client = \Wappointment\Models\Client::where('email', $email)->first();
            if (!\is_null($client)) {
    ...
    {
        $history = \Wappointment\Helpers\Get::style('table_history') . '<div id="wappointment-history"><table>';
    ...
    public function renderCancelRescheduleLink($appointment)
    {
        ...
        $widget = new \Wappointment\Services\WidgetSettings();
