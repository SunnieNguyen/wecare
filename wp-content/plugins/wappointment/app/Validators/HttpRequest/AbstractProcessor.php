...
abstract class AbstractProcessor implements \Wappointment\Validators\HttpRequest\InterfaceProcessor
{
    ...
    public function __construct(\Wappointment\ClassConnect\Request $request)
    {
        $this->request = $request;
        $this->validate();
        if ($this->autoResponse === true && $this->hasErrors()) {
            throw new \WappointmentValidationException(\Wappointment\Helpers\Translations::get('review_fields'), 1, null, $this->getErrors());
        }
    }
    ...
    private function validate() : bool
    {
        ...
        $this->validator = new \Wappointment\ClassConnect\RakitValidator();
