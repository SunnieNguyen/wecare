...
trait ManipulateLocation
{
    ...
    public function getLocation()
    {
        ...
        return \Wappointment\Services\AppointmentNew::getLocation($location, $this);
    }
    protected function getLocationObject()
    {
        return !empty($this->location) ? $this->location : \Wappointment\Models\Location::find($this->location_id);
    }
