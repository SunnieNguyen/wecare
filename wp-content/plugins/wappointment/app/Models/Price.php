...
class Price extends \Wappointment\ClassConnect\Model
{
    use SoftDeletes;
    ...
    public function generateItemName(\Wappointment\Models\TicketAbstract $ticket)
    {
    ...
    protected function generatePackageItemName(\Wappointment\Models\TicketAbstract $ticket)
    {
    ...
    {
        return \Wappointment\Models\Service::find($this->reference_id);
    }
}
