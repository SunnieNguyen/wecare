...
class Translator extends \WappoVendor\Symfony\Component\Translation\Translator
{
    /**
    ...
    public function __construct($locale, \WappoVendor\Symfony\Component\Translation\Formatter\MessageFormatterInterface $formatter = null, $cacheDir = null, $debug = false)
    {
        $this->addLoader('array', new \WappoVendor\Symfony\Component\Translation\Loader\ArrayLoader());
