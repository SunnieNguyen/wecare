 ...
 * @internal
 */
class AttributeNode extends \WappoVendor\Symfony\Component\CssSelector\Node\AbstractNode
{
    private $selector;
    private $namespace;
    private $attribute;
     ...
     * @param string $value
     */
    public function __construct(\WappoVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, $namespace, $attribute, $operator, $value)
    {
