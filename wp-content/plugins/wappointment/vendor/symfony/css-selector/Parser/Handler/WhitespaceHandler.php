 ...
 * @internal
 */
class WhitespaceHandler implements \WappoVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
{
    /**
     * {@inheritdoc}
     */
    public function handle(\WappoVendor\Symfony\Component\CssSelector\Parser\Reader $reader, \WappoVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream)
    {
        ...
        $stream->push(new \WappoVendor\Symfony\Component\CssSelector\Parser\Token(\WappoVendor\Symfony\Component\CssSelector\Parser\Token::TYPE_WHITESPACE, $match[0], $reader->getPosition()));
