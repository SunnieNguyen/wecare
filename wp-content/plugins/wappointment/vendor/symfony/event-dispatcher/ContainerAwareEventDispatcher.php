 ...
 */
class ContainerAwareEventDispatcher extends \WappoVendor\Symfony\Component\EventDispatcher\EventDispatcher
{
    private $container;
    /**
     ...
     */
    private $listeners = [];
    public function __construct(\WappoVendor\Symfony\Component\DependencyInjection\ContainerInterface $container)
    {
        $this->container = $container;
        $class = static::class;
        if ($this instanceof \WappoVendor\PHPUnit_Framework_MockObject_MockObject || $this instanceof \WappoVendor\PHPUnit\Framework\MockObject\MockObject || $this instanceof \WappoVendor\Prophecy\Doubler\DoubleInterface) {
