...
class Response
{
    ...
    {
        $this->headers = new \WappoVendor\Symfony\Component\HttpFoundation\ResponseHeaderBag($headers);
     ...
     * @final since version 3.3
     */
    public function isNotModified(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * @final since version 3.3
     */
    protected function ensureIEOverSSLCompatibility(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
