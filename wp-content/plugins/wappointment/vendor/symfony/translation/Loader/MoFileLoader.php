 ...
 */
class MoFileLoader extends \WappoVendor\Symfony\Component\Translation\Loader\FileLoader
{
    /**
    ...
    protected function loadResource($resource)
    {
        ...
        if ($stat['size'] < self::MO_HEADER_SIZE) {
            throw new \WappoVendor\Symfony\Component\Translation\Exception\InvalidResourceException('MO stream content has an invalid format.');
        }
        ...
        for ($i = 0; $i < $count; ++$i) {
            ...
            if (false !== \strpos($singularId, "\x00")) {
            ...
            if (false !== \strpos($translated, "\x00")) {
