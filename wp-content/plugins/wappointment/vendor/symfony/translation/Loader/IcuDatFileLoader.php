 ...
 * @author stealth35
 */
class IcuDatFileLoader extends \WappoVendor\Symfony\Component\Translation\Loader\IcuResFileLoader
{
    /**
     * {@inheritdoc}
     */
    public function load($resource, $locale, $domain = 'messages')
    {
        ...
        if (\class_exists('WappoVendor\\Symfony\\Component\\Config\\Resource\\FileResource')) {
            $catalogue->addResource(new \WappoVendor\Symfony\Component\Config\Resource\FileResource($resource . '.dat'));
        }
        return $catalogue;
    }
}
