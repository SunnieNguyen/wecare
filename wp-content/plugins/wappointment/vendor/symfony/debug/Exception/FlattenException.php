 ...
 */
namespace WappoVendor\Symfony\Component\Debug\Exception;
...
class FlattenException
{
    ...
    public static function create(\Exception $exception, $statusCode = null, array $headers = [])
    {
        ...
        if ($exception instanceof \WappoVendor\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \WappoVendor\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        ...
        if ($previous instanceof \Exception) {
            ...
            $e->setPrevious(static::create(new \WappoVendor\Symfony\Component\Debug\Exception\FatalThrowableError($previous)));
        }
        return $e;
    }
