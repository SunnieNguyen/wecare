...
class ExceptionHandler
{
    ...
    public static function register($debug = true, $charset = null, $fileLinkFormat = null)
    {
        ...
        if (\is_array($prev) && $prev[0] instanceof \WappoVendor\Symfony\Component\Debug\ErrorHandler) {
    ...
    {
        if (null === $this->handler || $exception instanceof \WappoVendor\Symfony\Component\Debug\Exception\OutOfMemoryException) {
    ...
    {
        if (!$exception instanceof \WappoVendor\Symfony\Component\Debug\Exception\FlattenException) {
            $exception = \WappoVendor\Symfony\Component\Debug\Exception\FlattenException::create($exception);
        }
        if (!\headers_sent()) {
     ...
     */
    public function getContent(\WappoVendor\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
...
EOF;
     ...
     */
    public function getStylesheet(\WappoVendor\Symfony\Component\Debug\Exception\FlattenException $exception)
    {
        if (!$this->debug) {
            return <<<'EOF'
