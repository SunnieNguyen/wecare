 ...
 */
class ControllerResolver implements \WappoVendor\Symfony\Component\HttpKernel\Controller\ArgumentResolverInterface, \WappoVendor\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface
{
    private $logger;
    /**
    ...
    public function __construct(\WappoVendor\Psr\Log\LoggerInterface $logger = null)
    {
        $this->logger = $logger;
    ...
    {
        @\trigger_error(\sprintf('The "%s()" method is deprecated as of 3.1 and will be removed in 4.0. Implement the %s and inject it in the HttpKernel instead.', __METHOD__, \WappoVendor\Symfony\Component\HttpKernel\Controller\ArgumentResolverInterface::class), \E_USER_DEPRECATED);
        if (\is_array($controller)) {
     ...
     * @deprecated This method is deprecated as of 3.1 and will be removed in 4.0. Implement the ArgumentResolverInterface and inject it in the HttpKernel instead.
     */
    protected function doGetArguments(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $controller, array $parameters)
    {
        @\trigger_error(\sprintf('The "%s()" method is deprecated as of 3.1 and will be removed in 4.0. Implement the %s and inject it in the HttpKernel instead.', __METHOD__, \WappoVendor\Symfony\Component\HttpKernel\Controller\ArgumentResolverInterface::class), \E_USER_DEPRECATED);
