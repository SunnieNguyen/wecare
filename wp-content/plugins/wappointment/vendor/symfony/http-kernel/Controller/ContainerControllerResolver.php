 ...
 */
class ContainerControllerResolver extends \WappoVendor\Symfony\Component\HttpKernel\Controller\ControllerResolver
{
    protected $container;
    public function __construct(\WappoVendor\Psr\Container\ContainerInterface $container, \WappoVendor\Psr\Log\LoggerInterface $logger = null)
    {
    ...
    {
        if ($this->container instanceof \WappoVendor\Symfony\Component\DependencyInjection\Container && isset($this->container->getRemovedIds()[$controller])) {
