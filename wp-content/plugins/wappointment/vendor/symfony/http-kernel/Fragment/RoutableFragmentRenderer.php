...
use WappoVendor\Symfony\Component\HttpKernel\EventListener\FragmentListener;
/**
 * Adds the possibility to generate a fragment URI for a given Controller.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
abstract class RoutableFragmentRenderer implements \WappoVendor\Symfony\Component\HttpKernel\Fragment\FragmentRendererInterface
{
     ...
     */
    protected function generateFragmentUri(\WappoVendor\Symfony\Component\HttpKernel\Controller\ControllerReference $reference, \WappoVendor\Symfony\Component\HttpFoundation\Request $request, $absolute = false, $strict = true)
    {
        if ($strict) {
