...
use WappoVendor\Symfony\Component\Templating\EngineInterface;
use WappoVendor\Twig\Environment;
use WappoVendor\Twig\Error\LoaderError;
use WappoVendor\Twig\Loader\ExistsLoaderInterface;
use WappoVendor\Twig\Loader\SourceContextLoaderInterface;
/**
 * Implements the Hinclude rendering strategy.
 *
 * @author Fabien Potencier <fabien@symfony.com>
 */
class HIncludeFragmentRenderer extends \WappoVendor\Symfony\Component\HttpKernel\Fragment\RoutableFragmentRenderer
{
     ...
     */
    public function __construct($templating = null, \WappoVendor\Symfony\Component\HttpKernel\UriSigner $signer = null, $globalDefaultTemplate = null, $charset = 'utf-8')
    {
    ...
    {
        if (null !== $templating && !$templating instanceof \WappoVendor\Symfony\Component\Templating\EngineInterface && !$templating instanceof \WappoVendor\Twig\Environment) {
    ...
    public function render($uri, \WappoVendor\Symfony\Component\HttpFoundation\Request $request, array $options = [])
    {
        ...
        return new \WappoVendor\Symfony\Component\HttpFoundation\Response(\sprintf('<hx:include src="%s"%s>%s</hx:include>', $uri, $renderedAttributes, $content));
    }
    /**
    ...
    {
        if ($this->templating instanceof \WappoVendor\Symfony\Component\Templating\EngineInterface) {
            try {
        ...
        if (1 === \WappoVendor\Twig\Environment::MAJOR_VERSION && !$loader instanceof \WappoVendor\Twig\Loader\ExistsLoaderInterface) {
            try {
                if ($loader instanceof \WappoVendor\Twig\Loader\SourceContextLoaderInterface) {
                    $loader->getSourceContext($template);
                } else {
                    $loader->getSource($template);
                }
                return true;
            } catch (\WappoVendor\Twig\Error\LoaderError $e) {
            }
            return false;
        }
