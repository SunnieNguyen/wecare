 ...
 */
class AddRequestFormatsListener implements \WappoVendor\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
    protected $formats;
    ...
    {
        return [\WappoVendor\Symfony\Component\HttpKernel\KernelEvents::REQUEST => ['onKernelRequest', 1]];
    }
}
