 ...
 */
abstract class AbstractSurrogate implements \WappoVendor\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface
{
    ...
    {
        return new \WappoVendor\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategy();
    }
    /**
     * {@inheritdoc}
     */
    public function hasSurrogateCapability(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function addSurrogateCapability(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     * {@inheritdoc}
     */
    public function needsParsing(\WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function handle(\WappoVendor\Symfony\Component\HttpKernel\HttpCache\HttpCache $cache, $uri, $alt, $ignoreErrors)
    {
        $subRequest = \WappoVendor\Symfony\Component\HttpFoundation\Request::create($uri, \WappoVendor\Symfony\Component\HttpFoundation\Request::METHOD_GET, [], $cache->getRequest()->cookies->all(), [], $cache->getRequest()->server->all());
        try {
            $response = $cache->handle($subRequest, \WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface::SUB_REQUEST, true);
     ...
     */
    protected function removeFromControl(\WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
