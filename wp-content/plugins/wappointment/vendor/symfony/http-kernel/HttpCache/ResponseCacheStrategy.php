 ...
 */
class ResponseCacheStrategy implements \WappoVendor\Symfony\Component\HttpKernel\HttpCache\ResponseCacheStrategyInterface
{
    /**
     ...
     * {@inheritdoc}
     */
    public function add(\WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * {@inheritdoc}
     */
    public function update(\WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     * @return bool
     */
    private function willMakeFinalResponseUncacheable(\WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
