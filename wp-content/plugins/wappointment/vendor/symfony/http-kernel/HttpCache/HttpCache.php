 ...
 */
class HttpCache implements \WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface, \WappoVendor\Symfony\Component\HttpKernel\TerminableInterface
{
    private $kernel;
    private $store;
    private $request;
     ...
     *                            (see RFC 5861).
     */
    public function __construct(\WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \WappoVendor\Symfony\Component\HttpKernel\HttpCache\StoreInterface $store, \WappoVendor\Symfony\Component\HttpKernel\HttpCache\SurrogateInterface $surrogate = null, array $options = [])
    {
        $this->store = $store;
        $this->kernel = $kernel;
        ...
        $this->options = \array_merge(['debug' => false, 'default_ttl' => 0, 'private_headers' => ['Authorization', 'Cookie'], 'allow_reload' => false, 'allow_revalidate' => false, 'stale_while_revalidate' => 2, 'stale_if_error' => 60], $options);
    }
    /**
    ...
    public function handle(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $type = \WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch = true)
    {
        ...
        if (\WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $type) {
            $this->traces = [];
        ...
        if (\WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $type && $this->options['debug']) {
    ...
    {
        if ($this->getKernel() instanceof \WappoVendor\Symfony\Component\HttpKernel\TerminableInterface) {
     ...
     */
    protected function pass(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $catch = false)
    {
     ...
     * @see RFC2616 13.10
     */
    protected function invalidate(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $catch = false)
    {
        $response = $this->pass($request, $catch);
            ...
            try {
                ...
                foreach (['Location', 'Content-Location'] as $header) {
                    if ($uri = $response->headers->get($header)) {
                        $subRequest = \WappoVendor\Symfony\Component\HttpFoundation\Request::create($uri, 'get', [], [], [], $request->server->all());
     ...
     * @throws \Exception
     */
    protected function lookup(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $catch = false)
    {
        try {
     ...
     * @return Response A Response instance
     */
    protected function validate(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, \WappoVendor\Symfony\Component\HttpFoundation\Response $entry, $catch = false)
    {
     ...
     * @return Response A Response instance
     */
    protected function fetch(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $catch = false)
    {
        $subRequest = clone $request;
        // send no head requests because we want content
        if ('HEAD' === $request->getMethod()) {
     ...
     * @return Response A Response instance
     */
    protected function forward(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $catch = false, \WappoVendor\Symfony\Component\HttpFoundation\Response $entry = null)
    {
        if ($this->surrogate) {
            $this->surrogate->addSurrogateCapability($request);
        }
        // always a "master" request (as the real master request can be in cache)
        $response = \WappoVendor\Symfony\Component\HttpKernel\HttpCache\SubRequestHandler::handle($this->kernel, $request, \WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST, $catch);
        /*
     ...
     */
    protected function isFreshEnough(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, \WappoVendor\Symfony\Component\HttpFoundation\Response $entry)
    {
        if (!$entry->isFresh()) {
     ...
     */
    protected function lock(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, \WappoVendor\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     * @throws \Exception
     */
    protected function store(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, \WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
        try {
     ...
     */
    private function restoreResponseBody(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, \WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
    ...
    protected function processResponseBody(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, \WappoVendor\Symfony\Component\HttpFoundation\Response $response)
    {
     ...
     */
    private function isPrivateRequest(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     */
    private function record(\WappoVendor\Symfony\Component\HttpFoundation\Request $request, $event)
    {
     ...
     * @return string
     */
    private function getTraceKey(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
     ...
     */
    private function mayServeStaleWhileRevalidate(\WappoVendor\Symfony\Component\HttpFoundation\Response $entry)
    {
     ...
     */
    private function waitForLock(\WappoVendor\Symfony\Component\HttpFoundation\Request $request)
    {
        $wait = 0;
