 ...
 */
final class ArgumentMetadataFactory implements \WappoVendor\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactoryInterface
{
    /**
    ...
    public function createArgumentMetadata($controller)
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            $arguments[] = new \WappoVendor\Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadata($param->getName(), $this->getType($param, $reflection), $this->isVariadic($param), $this->hasDefaultValue($param), $this->getDefaultValue($param), $param->allowsNull());
        }
        return $arguments;
    }
    /**
