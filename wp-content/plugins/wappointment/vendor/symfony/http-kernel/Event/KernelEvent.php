 ...
 */
class KernelEvent extends \WappoVendor\Symfony\Component\EventDispatcher\Event
{
    private $kernel;
    private $request;
    private $requestType;
     ...
     */
    public function __construct(\WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface $kernel, \WappoVendor\Symfony\Component\HttpFoundation\Request $request, $requestType)
    {
        $this->kernel = $kernel;
    ...
    {
        return \WappoVendor\Symfony\Component\HttpKernel\HttpKernelInterface::MASTER_REQUEST === $this->requestType;
    }
}
