 ...
 */
class FileProfilerStorage implements \WappoVendor\Symfony\Component\HttpKernel\Profiler\ProfilerStorageInterface
{
    /**
     ...
     * @throws \RuntimeException
     */
    public function write(\WappoVendor\Symfony\Component\HttpKernel\Profiler\Profile $profile)
    {
    ...
    {
        $profile = new \WappoVendor\Symfony\Component\HttpKernel\Profiler\Profile($token);
