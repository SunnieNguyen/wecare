 ...
 */
final class CouchbaseBucketCache extends \WappoVendor\Doctrine\Common\Cache\CacheProvider
{
    ...
    protected function doFetch($id)
    {
        ...
        if ($document instanceof \Couchbase\Document && $document->value !== false) {
    ...
    protected function doContains($id)
    {
        ...
        if ($document instanceof \Couchbase\Document) {
    ...
    protected function doGetStats()
    {
        ...
        return [\WappoVendor\Doctrine\Common\Cache\Cache::STATS_HITS => $interestingStats['get_hits'], \WappoVendor\Doctrine\Common\Cache\Cache::STATS_MISSES => $interestingStats['cmd_get'] - $interestingStats['get_hits'], \WappoVendor\Doctrine\Common\Cache\Cache::STATS_UPTIME => $node['uptime'], \WappoVendor\Doctrine\Common\Cache\Cache::STATS_MEMORY_USAGE => $interestingStats['mem_used'], \WappoVendor\Doctrine\Common\Cache\Cache::STATS_MEMORY_AVAILABLE => $node['memoryFree']];
    }
