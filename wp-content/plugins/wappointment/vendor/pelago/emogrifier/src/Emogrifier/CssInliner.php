 ...
 */
class CssInliner extends \WappoVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
{
    /**
     * @var int
     */
    ...
    private function getCssSelectorConverter()
    {
        if ($this->cssSelectorConverter === null) {
            $this->cssSelectorConverter = new \WappoVendor\Symfony\Component\CssSelector\CssSelectorConverter();
        }
    ...
    private function copyUninlinableCssToStyleNode($cssImportRules)
    {
        ...
        if ($this->matchingUninlinableCssRules !== []) {
            $cssConcatenator = new \WappoVendor\Pelago\Emogrifier\Utilities\CssConcatenator();
