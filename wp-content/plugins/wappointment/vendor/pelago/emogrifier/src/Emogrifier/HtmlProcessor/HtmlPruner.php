 ...
 */
class HtmlPruner extends \WappoVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
{
    /**
    ...
    {
        $classesToKeepIntersector = new \WappoVendor\Pelago\Emogrifier\Utilities\ArrayIntersector($classesToKeep);
        /** @var \DOMNode $element */
     ...
     */
    public function removeRedundantClassesAfterCssInlined(\WappoVendor\Pelago\Emogrifier\CssInliner $cssInliner)
    {
        $classesToKeepAsKeys = [];
