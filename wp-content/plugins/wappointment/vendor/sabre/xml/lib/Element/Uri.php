 ...
 */
class Uri implements \WappoVendor\Sabre\Xml\Element
{
    /**
     * Uri element value.
     *
    ...
    {
        $writer->text(\WappoVendor\Sabre\Uri\resolve($writer->contextUri, $this->value));
    }
    /**
    ...
    {
        return new self(\WappoVendor\Sabre\Uri\resolve($reader->contextUri, $reader->readText()));
    }
}
