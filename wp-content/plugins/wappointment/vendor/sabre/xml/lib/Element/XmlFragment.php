 ...
 */
class XmlFragment implements \WappoVendor\Sabre\Xml\Element
{
    /**
     * The inner XML value.
     *
...
XML;
        ...
        while ($reader->read()) {
            ...
            switch ($reader->nodeType) {
                case \WappoVendor\Sabre\Xml\Reader::ELEMENT:
                    ...
                    break;
                case \WappoVendor\Sabre\Xml\Reader::CDATA:
                case \WappoVendor\Sabre\Xml\Reader::TEXT:
                    $writer->text($reader->value);
                    break;
                case \WappoVendor\Sabre\Xml\Reader::END_ELEMENT:
                    $writer->endElement();
                    break;
            }
        }
