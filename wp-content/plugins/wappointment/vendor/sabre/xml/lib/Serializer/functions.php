 ...
 * @param string[] $values
 */
function enum(\WappoVendor\Sabre\Xml\Writer $writer, array $values)
{
 ...
 */
function valueObject(\WappoVendor\Sabre\Xml\Writer $writer, $valueObject, string $namespace)
{
 ...
 */
function repeatingElements(\WappoVendor\Sabre\Xml\Writer $writer, array $items, string $childElementName)
{
 ...
 */
function standardSerializer(\WappoVendor\Sabre\Xml\Writer $writer, $value)
{
    if (\is_scalar($value)) {
        // String, integer, float, boolean
        $writer->text((string) $value);
    } elseif ($value instanceof \WappoVendor\Sabre\Xml\XmlSerializable) {
