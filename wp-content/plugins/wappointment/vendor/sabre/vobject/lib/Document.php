 ...
 */
abstract class Document extends \WappoVendor\Sabre\VObject\Component
{
    /**
    ...
    public function createComponent($name, array $children = null, $defaults = true)
    {
        ...
        $class = 'WappoVendor\\Sabre\\VObject\\Component';
    ...
    public function createProperty($name, $value = null, array $parameters = null, $valueType = null)
    {
        ...
        if (\is_null($class)) {
            ...
            if (isset($parameters['VALUE'])) {
                ...
                if (\is_null($class)) {
                    throw new \WappoVendor\Sabre\VObject\InvalidDataException('Unsupported VALUE parameter for ' . $name . ' property. You supplied "' . $parameters['VALUE'] . '"');
                }
            } else {
    ...
    public function getClassNameForPropertyName($propertyName)
    {
        if (isset(static::$propertyMap[$propertyName])) {
            ...
            return 'WappoVendor\\Sabre\\VObject\\Property\\Unknown';
        }
    }
}
