 ...
 */
class Parameter extends \WappoVendor\Sabre\VObject\Node
{
    /**
     * Parameter name.
     *
     ...
     * @param string $value
     */
    public function __construct(\WappoVendor\Sabre\VObject\Document $root, $name, $value = null)
    {
    ...
    public function serialize()
    {
        ...
        if (\WappoVendor\Sabre\VObject\Document::VCARD21 === $this->root->getDocumentType() && $this->noName) {
