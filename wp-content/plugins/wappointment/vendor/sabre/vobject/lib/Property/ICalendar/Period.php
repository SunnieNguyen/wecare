 ...
 */
class Period extends \WappoVendor\Sabre\VObject\Property
{
    /**
    ...
    public function getJsonValue()
    {
        ...
        foreach ($this->getParts() as $item) {
            ...
            $start = \WappoVendor\Sabre\VObject\DateTimeParser::parseDateTime($start);
            // This is a duration value.
            if ('P' === $end[0]) {
                $return[] = [$start->format('Y-m-d\\TH:i:s'), $end];
            } else {
                $end = \WappoVendor\Sabre\VObject\DateTimeParser::parseDateTime($end);
