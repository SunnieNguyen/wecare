 ...
 */
class Text extends \WappoVendor\Sabre\VObject\Property
{
    /**
    ...
    {
        $this->setValue(\WappoVendor\Sabre\VObject\Parser\MimeDir::unescapeValue($val, $this->delimiter));
    }
    /**
    ...
    public function serialize()
    {
        ...
        if (\WappoVendor\Sabre\VObject\Document::VCARD21 !== $this->root->getDocumentType()) {
