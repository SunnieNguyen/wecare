 ...
 */
class DateAndOrTime extends \WappoVendor\Sabre\VObject\Property
{
    /**
     * Field separator.
     *
    ...
    public function getDateTime()
    {
        ...
        $nowParts = \WappoVendor\Sabre\VObject\DateTimeParser::parseVCardDateTime($now->format('Ymd\\This' . $tzFormat));
        $dateParts = \WappoVendor\Sabre\VObject\DateTimeParser::parseVCardDateTime($this->getValue());
    ...
    {
        $parts = \WappoVendor\Sabre\VObject\DateTimeParser::parseVCardDateTime($this->getValue());
        $dateStr = '';
        // Year
    ...
    protected function xmlSerializeValue(\WappoVendor\Sabre\Xml\Writer $writer)
    {
        ...
        $parts = \WappoVendor\Sabre\VObject\DateTimeParser::parseVCardDateAndOrTime($this->getValue());
        $value = '';
        // $d = defined
    ...
    public function validate($options = 0)
    {
        ...
        $value = $this->getValue();
        try {
            \WappoVendor\Sabre\VObject\DateTimeParser::parseVCardDateTime($value);
        } catch (\WappoVendor\Sabre\VObject\InvalidDataException $e) {
