 ...
 */
class ICalendar implements \WappoVendor\Sabre\VObject\Splitter\SplitterInterface
{
    /**
     * Timezones.
     *
    ...
    {
        $data = \WappoVendor\Sabre\VObject\Reader::read($input, $options);
        if (!$data instanceof \WappoVendor\Sabre\VObject\Component\VCalendar) {
            throw new \WappoVendor\Sabre\VObject\ParseException('Supplied input could not be parsed as VCALENDAR.');
        }
        foreach ($data->children() as $component) {
            ...
            if (!\array_key_exists($uid, $this->objects)) {
                $this->objects[$uid] = new \WappoVendor\Sabre\VObject\Component\VCalendar();
            }
    ...
    public function getNext()
    {
        if ($object = \array_shift($this->objects)) {
            ...
            $object->version = '2.0';
            $object->prodid = '-//Sabre//Sabre VObject ' . \WappoVendor\Sabre\VObject\Version::VERSION . '//EN';
