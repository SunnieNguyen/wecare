 ...
 */
class Json extends \WappoVendor\Sabre\VObject\Parser\Parser
{
    /**
     * The input data.
     *
    ...
    public function parse($input = null, $options = 0)
    {
        ...
        switch ($this->input[0]) {
            case 'vcalendar':
                ...
                break;
            case 'vcard':
                $this->root = new \WappoVendor\Sabre\VObject\Component\VCard([], false);
                break;
            default:
                throw new \WappoVendor\Sabre\VObject\ParseException('The root component must either be a vcalendar, or a vcard');
        }
    ...
    public function parseProperty(array $jProp)
    {
        ...
        if ('Sabre\\VObject\\Property\\FlatText' === $defaultPropertyClass) {
            $defaultPropertyClass = 'WappoVendor\\Sabre\\VObject\\Property\\Text';
        }
