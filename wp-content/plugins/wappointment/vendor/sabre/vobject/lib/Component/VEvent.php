 ...
 */
class VEvent extends \WappoVendor\Sabre\VObject\Component
{
    /**
    ...
    public function isInTimeRange(\DateTimeInterface $start, \DateTimeInterface $end)
    {
        if ($this->RRULE) {
            try {
                $it = new \WappoVendor\Sabre\VObject\Recur\EventIterator($this, null, $start->getTimezone());
        ...
        if (isset($this->DTEND)) {
            ...
            $effectiveEnd = $effectiveStart->add(\WappoVendor\Sabre\VObject\DateTimeParser::parseDuration($this->DURATION));
    ...
    {
        return ['UID' => 'sabre-vobject-' . \WappoVendor\Sabre\VObject\UUIDUtil::getUUID(), 'DTSTAMP' => \gmdate('WappoVendor\\Ymd\\THis\\Z')];
    }
    /**
