 ...
 */
class VAlarm extends \WappoVendor\Sabre\VObject\Component
{
    /**
    ...
    public function getEffectiveTriggerTime()
    {
        ...
        if (!isset($trigger['VALUE']) || 'DURATION' === \strtoupper($trigger['VALUE'])) {
            $triggerDuration = \WappoVendor\Sabre\VObject\DateTimeParser::parseDuration($this->TRIGGER);
            ...
            if ('START' === $related) {
                ...
                if ('VTODO' === $parentComponent->name) {
                    ...
                    throw new \WappoVendor\Sabre\VObject\InvalidDataException('time-range filters on VALARM components are only supported when they are a child of VTODO or VEVENT');
                }
                if (isset($parentComponent->{$endProp})) {
                    ...
                    $duration = \WappoVendor\Sabre\VObject\DateTimeParser::parseDuration($parentComponent->DURATION);
    ...
    public function isInTimeRange(\DateTimeInterface $start, \DateTimeInterface $end)
    {
        ...
        if (isset($this->DURATION)) {
            $duration = \WappoVendor\Sabre\VObject\DateTimeParser::parseDuration($this->DURATION);
