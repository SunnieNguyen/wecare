 ...
 */
class VFreeBusy extends \WappoVendor\Sabre\VObject\Component
{
    /**
    ...
    public function isFree(\DateTimeInterface $start, \DateTimeInterface $end)
    {
        foreach ($this->select('FREEBUSY') as $freebusy) {
            ...
            foreach ($periods as $period) {
                ...
                $busyStart = \WappoVendor\Sabre\VObject\DateTimeParser::parse($busyStart);
                $busyEnd = \WappoVendor\Sabre\VObject\DateTimeParser::parse($busyEnd);
