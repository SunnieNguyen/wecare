 ...
 */
class VTodo extends \WappoVendor\Sabre\VObject\Component
{
    /**
    ...
    public function isInTimeRange(\DateTimeInterface $start, \DateTimeInterface $end)
    {
        ...
        $duration = isset($this->DURATION) ? \WappoVendor\Sabre\VObject\DateTimeParser::parseDuration($this->DURATION) : null;
    ...
    {
        return ['UID' => 'sabre-vobject-' . \WappoVendor\Sabre\VObject\UUIDUtil::getUUID(), 'DTSTAMP' => \date('WappoVendor\\Ymd\\THis\\Z')];
    }
}
