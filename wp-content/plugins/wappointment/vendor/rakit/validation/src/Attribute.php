...
class Attribute
{
    ...
    public function __construct(\WappoVendor\Rakit\Validation\Validation $validation, $key, $alias = null, array $rules = array())
    {
    ...
    public function setPrimaryAttribute(\WappoVendor\Rakit\Validation\Attribute $primaryAttribute)
    {
    ...
    public function addOtherAttribute(\WappoVendor\Rakit\Validation\Attribute $otherAttribute)
    {
    ...
    public function addRule(\WappoVendor\Rakit\Validation\Rule $rule)
    {
    ...
    public function getHumanizedKey()
    {
        ...
        if ($primaryAttribute) {
            ...
            $key = \implode(' ', \array_map(function ($word) {
                ...
                return \WappoVendor\Rakit\Validation\Helper::snakeCase($word, ' ');
            }, $split));
        }
        return \ucfirst($key);
    }
