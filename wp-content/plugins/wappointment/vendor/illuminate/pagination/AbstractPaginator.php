 ...
 */
abstract class AbstractPaginator implements \WappoVendor\Illuminate\Contracts\Support\Htmlable
{
    /**
    ...
    public function url($page)
    {
        ...
        return $this->path . (\WappoVendor\Illuminate\Support\Str::contains($this->path, '?') ? '&' : '?') . \http_build_query($parameters, '', '&') . $this->buildFragment();
    }
    /**
     ...
     * @return $this
     */
    public function setCollection(\WappoVendor\Illuminate\Support\Collection $collection)
    {
