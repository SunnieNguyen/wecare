...
class ViewErrorBag implements \Countable
{
    ...
    {
        return \WappoVendor\Illuminate\Support\Arr::get($this->bags, $key) ?: new \WappoVendor\Illuminate\Support\MessageBag();
    }
    /**
     * Get all the bags.
     *
     ...
     * @return $this
     */
    public function put($key, \WappoVendor\Illuminate\Contracts\Support\MessageBag $bag)
    {
        $this->bags[$key] = $bag;
        return $this;
    }
