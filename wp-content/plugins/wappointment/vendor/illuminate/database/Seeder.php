...
abstract class Seeder
{
    ...
    {
        $classes = \WappoVendor\Illuminate\Support\Arr::wrap($class);
     ...
     * @return $this
     */
    public function setContainer(\WappoVendor\Illuminate\Container\Container $container)
    {
     ...
     * @return $this
     */
    public function setCommand(\WappoVendor\Illuminate\Console\Command $command)
    {
