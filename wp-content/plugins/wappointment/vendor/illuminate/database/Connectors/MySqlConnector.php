...
use PDO;
class MySqlConnector extends \WappoVendor\Illuminate\Database\Connectors\Connector implements \WappoVendor\Illuminate\Database\Connectors\ConnectorInterface
{
    /**
