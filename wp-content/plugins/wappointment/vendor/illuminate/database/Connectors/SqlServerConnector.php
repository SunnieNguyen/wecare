...
class SqlServerConnector extends \WappoVendor\Illuminate\Database\Connectors\Connector implements \WappoVendor\Illuminate\Database\Connectors\ConnectorInterface
{
    /**
    ...
    {
        return $this->buildConnectString('dblib', \array_merge(['host' => $this->buildHostString($config, ':'), 'dbname' => $config['database']], \WappoVendor\Illuminate\Support\Arr::only($config, ['appname', 'charset', 'version'])));
    }
    /**
