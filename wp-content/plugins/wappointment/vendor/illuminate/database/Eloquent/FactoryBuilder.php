...
class FactoryBuilder
{
     ...
     * @return void
     */
    public function __construct($class, $name, array $definitions, array $states, \WappoVendor\Faker\Generator $faker)
    {
        $this->name = $name;
        $this->class = $class;
        $this->faker = $faker;
    ...
    public function create(array $attributes = [])
    {
        ...
        if ($results instanceof \WappoVendor\Illuminate\Database\Eloquent\Model) {
    ...
    {
        return \WappoVendor\Illuminate\Database\Eloquent\Model::unguarded(function () use($attributes) {
    ...
    protected function expandAttributes(array $attributes)
    {
        foreach ($attributes as &$attribute) {
            ...
            if ($attribute instanceof \WappoVendor\Illuminate\Database\Eloquent\Model) {
