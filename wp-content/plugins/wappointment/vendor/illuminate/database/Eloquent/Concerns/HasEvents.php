...
trait HasEvents
{
    ...
    {
        return \array_merge(['retrieved', 'creating', 'created', 'updating', 'updated', 'deleting', 'deleted', 'saving', 'saved', 'restoring', 'restored'], $this->observables);
    }
    /**
     ...
     * @return void
     */
    public static function setEventDispatcher(\WappoVendor\Illuminate\Contracts\Events\Dispatcher $dispatcher)
    {
