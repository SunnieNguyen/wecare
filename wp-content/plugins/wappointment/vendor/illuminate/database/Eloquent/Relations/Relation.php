...
abstract class Relation
{
     ...
     * @return void
     */
    public function __construct(\WappoVendor\Illuminate\Database\Eloquent\Builder $query, \WappoVendor\Illuminate\Database\Eloquent\Model $parent)
    {
        $this->query = $query;
        $this->parent = $parent;
     ...
     * @return array
     */
    public abstract function match(array $models, \WappoVendor\Illuminate\Database\Eloquent\Collection $results, $relation);
    /**
     ...
     */
    public function getRelationExistenceCountQuery(\WappoVendor\Illuminate\Database\Eloquent\Builder $query, \WappoVendor\Illuminate\Database\Eloquent\Builder $parentQuery)
    {
        return $this->getRelationExistenceQuery($query, $parentQuery, new \WappoVendor\Illuminate\Database\Query\Expression('count(*)'))->setBindings([], 'select');
    }
    /**
    ...
    {
        if (\is_null($models) || \WappoVendor\Illuminate\Support\Arr::isAssoc($models)) {
            return $models;
        }
