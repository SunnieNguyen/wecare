...
class BelongsToMany extends \WappoVendor\Illuminate\Database\Eloquent\Relations\Relation
{
     ...
     * @return void
     */
    public function __construct(\WappoVendor\Illuminate\Database\Eloquent\Builder $query, \WappoVendor\Illuminate\Database\Eloquent\Model $parent, $table, $foreignPivotKey, $relatedPivotKey, $parentKey, $relatedKey, $relationName = null)
    {
        $this->table = $table;
     ...
     * @return array
     */
    protected function migratePivotAttributes(\WappoVendor\Illuminate\Database\Eloquent\Model $model)
    {
        $values = [];
    ...
    {
        return \WappoVendor\Illuminate\Support\Str::camel(\WappoVendor\Illuminate\Support\Str::plural(\WappointmentLv::class_basename($this->getParent())));
    }
    /**
     ...
     * @return \Illuminate\Database\Eloquent\Model
     */
    public function save(\WappoVendor\Illuminate\Database\Eloquent\Model $model, array $pivotAttributes = [], $touch = true)
    {
     ...
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function getRelationExistenceQueryForSelfJoin(\WappoVendor\Illuminate\Database\Eloquent\Builder $query, \WappoVendor\Illuminate\Database\Eloquent\Builder $parentQuery, $columns = ['*'])
    {
