 ...
 */
class BelongsTo extends \WappoVendor\Illuminate\Database\Eloquent\Relations\Relation
{
     ...
     * @return void
     */
    public function __construct(\WappoVendor\Illuminate\Database\Eloquent\Builder $query, \WappoVendor\Illuminate\Database\Eloquent\Model $child, $foreignKey, $ownerKey, $relation)
    {
    ...
    {
        $ownerKey = $model instanceof \WappoVendor\Illuminate\Database\Eloquent\Model ? $model->getAttribute($this->ownerKey) : $model;
        $this->child->setAttribute($this->foreignKey, $ownerKey);
        if ($model instanceof \WappoVendor\Illuminate\Database\Eloquent\Model) {
     ...
     * @return \Illuminate\Database\Eloquent\Model
     */
    protected function newRelatedInstanceFor(\WappoVendor\Illuminate\Database\Eloquent\Model $parent)
    {
