...
trait InteractsWithPivotTable
{
    ...
    {
        if ($value instanceof \WappoVendor\Illuminate\Database\Eloquent\Model) {
            return [$value->{$this->relatedKey}];
        }
        if ($value instanceof \WappoVendor\Illuminate\Database\Eloquent\Collection) {
            return $value->pluck($this->relatedKey)->all();
        }
        if ($value instanceof \WappoVendor\Illuminate\Support\Collection) {
