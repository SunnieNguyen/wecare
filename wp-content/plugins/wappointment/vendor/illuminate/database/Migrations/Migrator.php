...
class Migrator
{
     ...
     * @return void
     */
    public function __construct(\WappoVendor\Illuminate\Database\Migrations\MigrationRepositoryInterface $repository, \WappoVendor\Illuminate\Database\ConnectionResolverInterface $resolver, \WappoVendor\Illuminate\Filesystem\Filesystem $files)
    {
        $this->files = $files;
    ...
    {
        return \WappoVendor\Illuminate\Support\Collection::make($files)->reject(function ($file) use($ran) {
    ...
    protected function rollbackMigrations(array $migrations, $paths, array $options)
    {
        ...
        foreach ($migrations as $migration) {
            ...
            if (!($file = \WappoVendor\Illuminate\Support\Arr::get($files, $migration->migration))) {
    ...
    {
        $class = \WappoVendor\Illuminate\Support\Str::studly(\implode('_', \array_slice(\explode('_', $file), 4)));
        return new $class();
    }
    /**
    ...
    {
        return \WappoVendor\Illuminate\Support\Collection::make($paths)->flatMap(function ($path) {
