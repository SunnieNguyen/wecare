...
class SQLiteGrammar extends \WappoVendor\Illuminate\Database\Schema\Grammars\Grammar
{
    /**
     ...
     * @return string|null
     */
    protected function addForeignKeys(\WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint)
    {
     ...
     * @return string|null
     */
    protected function addPrimaryKeys(\WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint)
    {
    ...
    public function compileAdd(\WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint, \WappoVendor\Illuminate\Support\Fluent $command)
    {
        ...
        return \WappointmentLv::collect($columns)->map(function ($column) use($blueprint) {
     ...
     * @return array
     */
    public function compileDropColumn(\WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint, \WappoVendor\Illuminate\Support\Fluent $command, \WappoVendor\Illuminate\Database\Connection $connection)
    {
