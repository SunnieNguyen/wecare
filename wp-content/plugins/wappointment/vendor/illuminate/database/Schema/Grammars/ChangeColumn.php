...
class ChangeColumn
{
     ...
     */
    public static function compile($grammar, \WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint, \WappoVendor\Illuminate\Support\Fluent $command, \WappoVendor\Illuminate\Database\Connection $connection)
    {
     ...
     */
    protected static function getChangedDiff($grammar, \WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint, \WappoVendor\Doctrine\DBAL\Schema\AbstractSchemaManager $schema)
    {
        $current = $schema->listTableDetails($grammar->getTablePrefix() . $blueprint->getTable());
        return (new \WappoVendor\Doctrine\DBAL\Schema\Comparator())->diffTable($current, static::getTableWithColumnChanges($blueprint, $current));
    }
    /**
     ...
     */
    protected static function getTableWithColumnChanges(\WappoVendor\Illuminate\Database\Schema\Blueprint $blueprint, \WappoVendor\Doctrine\DBAL\Schema\Table $table)
    {
        $table = clone $table;
     ...
     */
    protected static function getDoctrineColumn(\WappoVendor\Doctrine\DBAL\Schema\Table $table, \WappoVendor\Illuminate\Support\Fluent $fluent)
    {
     ...
     * @return array
     */
    protected static function getDoctrineColumnChangeOptions(\WappoVendor\Illuminate\Support\Fluent $fluent)
    {
    ...
    protected static function getDoctrineColumnType($type)
    {
        ...
        return \WappoVendor\Doctrine\DBAL\Types\Type::getType($type);
    }
    /**
