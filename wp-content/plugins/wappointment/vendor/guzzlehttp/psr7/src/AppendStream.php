 ...
 */
class AppendStream implements \WappoVendor\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\WappoVendor\Psr\Http\Message\StreamInterface $stream)
    {
