 ...
 */
class FnStream implements \WappoVendor\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\WappoVendor\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
