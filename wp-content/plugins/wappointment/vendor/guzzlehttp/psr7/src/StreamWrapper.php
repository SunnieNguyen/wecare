...
class StreamWrapper
{
     ...
     */
    public static function getResource(\WappoVendor\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\WappoVendor\Psr\Http\Message\StreamInterface $stream)
    {
