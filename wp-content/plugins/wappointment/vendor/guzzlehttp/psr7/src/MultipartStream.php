 ...
 */
class MultipartStream implements \WappoVendor\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \WappoVendor\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\WappoVendor\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \WappoVendor\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
